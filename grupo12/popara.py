...
class JogoDaVelha(GridLayout):
            ...
            if self.verificar_vencedor():
                ...
                if max(self.pontuacao_jogadores.values()) == 3:
                    ...
                    for botao in self.botoes:
                        ...
                        botao.background_color = (1, 1, 1, 1)  # Resetar cor de fundo
    ...
    def verificar_vencedor(self):
        ...
        for i in range(3):
            if (self.botoes[i * 3].text == self.botoes[i * 3 + 1].text == self.botoes[i * 3 + 2].text != '') or (self.botoes[i].text == self.botoes[i + 3].text == self.botoes[i + 6].text != ''):
    ...
    def reiniciar_tabuleiro(self):
        for botao in self.botoes:
            ...
            botao.background_color = (1, 1, 1, 1)  
        self.jogador_atual = 'X'
